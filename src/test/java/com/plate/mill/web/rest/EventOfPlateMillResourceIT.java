...
public class EventOfPlateMillResourceIT {
    ...
    public void setup() {
        ...
        final EventOfPlateMillResource eventOfPlateMillResource = new EventOfPlateMillResource(eventOfPlateMillRepository, mockEventOfPlateMillSearchRepository);
    ...
    public void searchEventOfPlateMill() throws Exception {
        // Initialize the database
        eventOfPlateMillRepository.saveAndFlush(eventOfPlateMill);
        when(mockEventOfPlateMillSearchRepository.search(queryStringQuery("id:" + eventOfPlateMill.getId())))
            .thenReturn(Collections.singletonList(eventOfPlateMill));

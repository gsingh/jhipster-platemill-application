...
public class ProductionResourceIT {
    ...
    public void setup() {
        ...
        final ProductionResource productionResource = new ProductionResource(productionRepository, mockProductionSearchRepository);
    ...
    public void searchProduction() throws Exception {
        // Initialize the database
        productionRepository.saveAndFlush(production);
        when(mockProductionSearchRepository.search(queryStringQuery("id:" + production.getId())))
            .thenReturn(Collections.singletonList(production));

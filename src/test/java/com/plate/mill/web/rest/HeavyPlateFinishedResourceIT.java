...
public class HeavyPlateFinishedResourceIT {
    ...
    public void setup() {
        ...
        final HeavyPlateFinishedResource heavyPlateFinishedResource = new HeavyPlateFinishedResource(heavyPlateFinishedRepository, mockHeavyPlateFinishedSearchRepository);
    ...
    public void searchHeavyPlateFinished() throws Exception {
        // Initialize the database
        heavyPlateFinishedRepository.saveAndFlush(heavyPlateFinished);
        when(mockHeavyPlateFinishedSearchRepository.search(queryStringQuery("id:" + heavyPlateFinished.getId())))
            .thenReturn(Collections.singletonList(heavyPlateFinished));

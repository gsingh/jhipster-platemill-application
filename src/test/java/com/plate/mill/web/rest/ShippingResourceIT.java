...
public class ShippingResourceIT {
    ...
    public void setup() {
        ...
        final ShippingResource shippingResource = new ShippingResource(shippingRepository, mockShippingSearchRepository);
    ...
    public void searchShipping() throws Exception {
        // Initialize the database
        shippingRepository.saveAndFlush(shipping);
        when(mockShippingSearchRepository.search(queryStringQuery("id:" + shipping.getId())))
            .thenReturn(Collections.singletonList(shipping));
        // Search the shipping

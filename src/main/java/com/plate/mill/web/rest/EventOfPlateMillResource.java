...
public class EventOfPlateMillResource {
    ...
    public EventOfPlateMillResource(EventOfPlateMillRepository eventOfPlateMillRepository, EventOfPlateMillSearchRepository eventOfPlateMillSearchRepository) {
    ...
    public List<EventOfPlateMill> searchEventOfPlateMills(@RequestParam String query) {
        log.debug("REST request to search EventOfPlateMills for query {}", query);
        return StreamSupport
            .stream(eventOfPlateMillSearchRepository.search(queryStringQuery(query)).spliterator(), false)

...
public class NormalisingResource {
    ...
    public NormalisingResource(NormalisingRepository normalisingRepository, NormalisingSearchRepository normalisingSearchRepository) {
    ...
    public List<Normalising> searchNormalisings(@RequestParam String query) {
        log.debug("REST request to search Normalisings for query {}", query);
        return StreamSupport
            .stream(normalisingSearchRepository.search(queryStringQuery(query)).spliterator(), false)
